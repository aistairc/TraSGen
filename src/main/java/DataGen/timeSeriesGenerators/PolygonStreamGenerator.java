...
public class PolygonStreamGenerator implements StreamGenerator {
    ...
    public PolygonStreamGenerator( int minPoints, int maxPoints) {
    ...
    public PolygonStreamGenerator(int minPoints, int maxPoints, int minHoles, int maxHoles,
        ...
        return objIDStream
                ...
                .map(new AbstractRichMapFunction<Envelope>(Envelope.class, this.seriesBBox, Params.randomOption,
                    ...
                    public String map(Tuple2<Integer, Long> objIDTuple) throws Exception {
                        ...
                        Geometry geometry = HelperClass.generatePolygon(nPolygonPoints, nPolygonHoles, geometryBBox, geometryGenAlgorithm);
