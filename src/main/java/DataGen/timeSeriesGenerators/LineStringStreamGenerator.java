...
public class LineStringStreamGenerator implements StreamGenerator {
    ...
    public LineStringStreamGenerator() {
        this.minPoints = NUM_OF_POINTS;
        this.maxPoints = NUM_OF_POINTS;
    }

    public LineStringStreamGenerator(Envelope seriesBBox,  int minPoints, int maxPoints/*, double segmentLengthVar*/,
                                     int geometryGenAlgorithm, String format, String dateFormat, String initialTimeStamp, int timeStepinMilliSec, Random timeGen, boolean randomizeTimeInBatch) {
        ...
        return objIDStream
                ...
                .map(new AbstractRichMapFunction<Envelope>(Envelope.class, this.seriesBBox, Params.randomOption,
                    ...
                    public String map(Tuple2<Integer, Long> objIDTuple) throws Exception {
                        ...
                        Geometry geometry = HelperClass.generateLineString(nLineStringPoints, geometryBBox, geometryGenAlgorithm);
