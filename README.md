...
| Name        | randomOption                                                                                                                                                  |
|------------|------------------------------------------------------------|
| Value       | {"none", "uniform", "gaussian", "gaussianRW", "brownRW", "hotspot", "hotspotRW"}                                                                              |
| Description | If a network is not given, you can define the random distribution of data points to be generated within the "bbox" bounds using any one of the options above. |

| Name        | datatypeOption                                                                                                                                                                                                                            |
|------------|------------------------------------------------------------|
| Value       | {"point", "multiPoint", "networkPoint"}                                                                                                                                                                                                   |
| Description | Select "networkPoint" to generate trajectory points on the network using the shortest path algorithm. "Point" and "multiPoint" to randomly generate points following the distribution defined by "randomOption" within the "bbox" bounds. |
