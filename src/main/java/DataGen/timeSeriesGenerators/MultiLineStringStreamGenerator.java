...
public class MultiLineStringStreamGenerator implements StreamGenerator {
    ...
    public MultiLineStringStreamGenerator() {
    ...
    public MultiLineStringStreamGenerator(int minPoints, int maxPoints) {
    ...
    public MultiLineStringStreamGenerator(int minPoints, int maxPoints, double seriesVariance) {
    ...
    public MultiLineStringStreamGenerator(int minPoints, int maxPoints, int minGeometries, int maxGeometries) {
    ...
    public MultiLineStringStreamGenerator(int minPoints, int maxPoints, int minGeometries, int maxGeometries,
                                          double seriesVariance, int multiGeometryGenAlgorithm, int geometryGenAlgorithm, String format, String dateFormat, String initialTimeStamp, int timeStepinMilliSec, Random timeGen, boolean randomizeTimeInBatch) {
        ...
        return objIDStream
                ...
                .map(new AbstractRichMapFunction<Envelope>(Envelope.class, this.seriesBBox, Params.randomOption,
                    ...
                    public String map(Tuple2<Integer, Long> objIDTuple) throws Exception {
                        ...
                        int nLineStringPoints = HelperClass.getRandomIntInRange(minPoints, maxPoints);
                        int nGeometries = HelperClass.getRandomIntInRange(minGeometries, maxGeometries);
                        Geometry geometry = HelperClass.generateMultiLineString(nLineStringPoints, nGeometries, geometryBBox, multiGeometryGenAlgorithm, geometryGenAlgorithm);
...
//                            return Serialization.generateGeometryWKT(
//                                    geometry, objID, simpleDateFormat.format(HelperClass.localDateTimeToDate(localDateTime)));
                        }
                    }
                });
    }
